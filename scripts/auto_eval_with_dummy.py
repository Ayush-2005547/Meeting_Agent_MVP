...
for item in dataset:
    ...
    # If generated summary is empty, fill dummy
    if not gen.strip():
        gen = f"This is a placeholder summary for meeting {item['meeting_id']}."
...
print(f"Dummy evaluation done, results saved to {OUTPUT_PATH}")
